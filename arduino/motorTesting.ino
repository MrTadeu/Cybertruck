...
#define MAX_PULSE_LENGTH 1400 //DEFAULT - 2000 / SAFE - 1400 // Maximum pulse in µs
    ...
    if (Serial.available()) {
        ...
        switch (data) {
            ...
            case '3': // Forward maximum throttle
                ...
                setThrottle(MAX_PULSE_LENGTH, 0);
                break;
            ...
            case '5': // Reverse maximum throttle
                ...
                setThrottle(MAX_PULSE_LENGTH, 1);
                break;
